...
falhou=0
for teste in test_terminal.py test_sessao.py test_arquivos.py test_arvore.py test_abas.py test_divisao.py test_subpasta.py test_divisorias.py test_realce.py test_persistencia.py test_reconexao.py; do
  echo
  echo "=============== $teste ==============="
